class CreateTriggerCountStatisticWhenEditKeywordInsert < ActiveRecord::Migration
  def self.up
 #   execute "DROP TRIGGER IF EXISTS count_statistics_keyword_for_edit_insert"
    execute <<SQL
          ...
          -- IF new.edit_status != 'n' OR new.edit_status IS NULL THEN
              ...
              IF k_type IS NOT NULL AND r_time IS NOT NULL THEN
                 ...
                 ELSE
                    ...
                    VALUES (r_time,agent,s_type,daily_value,NOW(),NOW());
                 END IF;
              END IF;
                 SET daily_value = 0;
