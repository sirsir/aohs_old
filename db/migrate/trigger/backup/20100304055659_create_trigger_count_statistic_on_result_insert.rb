class CreateTriggerCountStatisticOnResultInsert < ActiveRecord::Migration
  def self.up
#    execute 'DROP TRIGGER IF EXISTS count_statistics_for_result_insert'
    execute <<SQL
...
SQL
  ...
  def self.down
     execute 'DROP TRIGGER IF EXISTS modify_statistic_for_result_insert'
  end
end
