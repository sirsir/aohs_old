...
Rails::Initializer.run do |config|
  ...
  #config.logger = Logger.new(File.join(RAILS_ROOT,'log',"#{RAILS_ENV}.log"), "daily")
  ...
  config.action_controller.session = {
    :session_key => '_amivoice_operators_help_session',
    :secret      => '9b230586fc3154d09653effb2d3376eb79a845d2370b2166dee57a5d7da561fa3f761631b9b990a99e19812c4403986b7f8eedd141827c071553df1d0d97fda4'
  }
...
#require File.join(RAILS_ROOT,'lib','ami_scheduler')
