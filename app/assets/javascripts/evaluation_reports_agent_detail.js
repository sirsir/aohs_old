var fnRp = {
  ...
  loadTable: function(){
    ...
    jQuery.getJSON(Routes.agent_detail_evaluation_reports_path({format: 'json'}),params,renderTable);
  },
  
  downloadFile: function(){
    var params = fnEvaluationRp.getEvaluationFilters();
    appl.fileDownload(appl.mkUrl(Routes.agent_detail_evaluation_reports_path({format: 'xlsx'}), params));
  },
};
