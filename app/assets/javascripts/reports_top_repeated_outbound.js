var fnRp = {
  ...
  loadTable: function(){
    ...
    jQuery.getJSON(Routes.top_repeated_outbound_reports_path({format: 'json'}),params,renderTable);
  },
  
  downloadFile: function(){
    var params = fn_reports.getCallFilter();
    appl.fileDownload(appl.mkUrl(Routes.top_repeated_outbound_reports_path({format: 'xlsx'}), params));
  },
};
