var fnRp = {
  ...
  loadTable: function(){
    ...
    jQuery.getJSON(Routes.acs_ngusage_summary_evaluation_reports_path({format: 'json'}),params,renderTable);
  },
  
  downloadFile: function(){
    var params = fnEvaluationRp.getEvaluationFilters();
    appl.fileDownload(appl.mkUrl(Routes.acs_ngusage_summary_evaluation_reports_path({format: 'xlsx'}), params));
  },
};
