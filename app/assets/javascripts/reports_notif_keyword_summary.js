var fnRp = {
  ...
  loadTable: function(){
    ...
    jQuery.getJSON(Routes.notif_keyword_summary_reports_path({format: 'json'}),params,renderTable);
  },
  downloadFile: function(){
    var params = fn_reports.getCallFilter();
    appl.fileDownload(appl.mkUrl(Routes.notif_keyword_summary_reports_path({format: 'xlsx'}), params));
  },
};
